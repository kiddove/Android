...
import com.kectech.android.wyslink.adapter.ShowOfMainAdapter;
 ...
 */
public class ShowOfMainActivity extends Activity implements OnSwipeOutListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (intent != null) {
                ...
                KecUtilities.createSubFolders(MainActivity.USER + File.separator + MainActivity.SHOW_SUB_FOLDER + File.separator + tabName);
            }
            ...
            adapter = new ShowOfMainAdapter(getFragmentManager(), Titles, NumOfTabs, tabName, tabOwner);
