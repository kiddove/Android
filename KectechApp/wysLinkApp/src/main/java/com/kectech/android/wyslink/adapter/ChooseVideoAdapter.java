 ...
 */
public class ChooseVideoAdapter extends ArrayAdapter<ChooseVideoGridItem> {

    private ImageFetcher mImageFetcher;
    private Context mContext;

    private LinkedHashMap<Integer, Boolean> selection = new LinkedHashMap<>();
    public ChooseVideoAdapter(Context context, int resourceId, ArrayList<ChooseVideoGridItem> items, ImageFetcher imageFetcher) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        ChooseVideoGridItem item = getItem(position);
