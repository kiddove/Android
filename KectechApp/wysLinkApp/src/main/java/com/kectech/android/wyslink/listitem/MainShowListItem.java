 ...
 */
public class MainShowListItem {
    private String title = null;
    private String desc = null;
    private int type;
    private String thumb = null;
    private int id;
    private String keyid = null;    // name
    private String owner = null;   // owner

    public MainShowListItem(MainShowListItem item) {
...
//                case 3:
//                    // event hall
//                    return "http://www.kdlinx.com/EHLogo.ashx?type=0&owner=" + this.owner + "&eh=" + URLEncoder.encode(this.keyid, MainActivity.ENCODING);
//                default:
//                    return null;
//            }
            ...
            return String.format("http://206.190.141.88/simg.ashx?name=%s", URLEncoder.encode(this.keyid, MainActivity.ENCODING));
