 ...
 *******************************************************************************/
package com.kectech.android.wyslink.thirdparty.UniversalImageLoader.core.decode;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
