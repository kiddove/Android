...
public class ShowListViewAdapter extends ArrayAdapter<MainShowListItem> {
    ...
    public ShowListViewAdapter(Context context, int resourceId, ArrayList<MainShowListItem> items, ImageFetcher imageFetcher) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        MainShowListItem item = getItem(position);
