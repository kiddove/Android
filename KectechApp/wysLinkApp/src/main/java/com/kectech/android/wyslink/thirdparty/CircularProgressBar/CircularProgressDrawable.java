package com.kectech.android.wyslink.thirdparty.CircularProgressBar;
  ...
  private void setupAnimations() {
    ...
    mRotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      ...
      public void onAnimationUpdate(ValueAnimator animation) {
        float angle = CircularProgressBarUtils.getAnimatedFraction(animation) * 360f;
    ...
    mSweepAppearingAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      @Override
      public void onAnimationUpdate(ValueAnimator animation) {
        float animatedFraction = CircularProgressBarUtils.getAnimatedFraction(animation);
        float angle;
    ...
    mEndAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      @Override
      public void onAnimationUpdate(ValueAnimator animation) {
        setEndRatio(1f - CircularProgressBarUtils.getAnimatedFraction(animation));
