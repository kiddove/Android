...
package com.kectech.android.kectechapp.thirdparty.CacheBitmap;
    ...
    */
    ...
    public boolean downloadUrlToStream(String urlString, OutputStream outputStream) {
        ...
        try {
            ...
            //progressBar.setMax(urlConnection.getContentLength());
            ...
            while ((b = in.read()) != -1) {
                out.write(b);
                //getBitmapWorkerTask(imageView).setProgress(b);
                //publishProgress(b);
            }
            return true;
