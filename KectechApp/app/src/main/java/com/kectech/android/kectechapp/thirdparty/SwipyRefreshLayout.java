 ...
 * indication of a refresh. If an activity wishes to tab_main_show just the progress
...
public class SwipyRefreshLayout extends ViewGroup {
     ...
     */
    /*
    tab_main_public void setProgressViewOffset(boolean scale, int start, int end) {
        mScale = scale;
        mCircleView.setVisibility(View.GONE);
     ...
     */
    /*
    tab_main_public void setProgressViewEndTarget(boolean scale, int end) {
        mSpinnerFinalOffset = end;
        mScale = scale;
        mCircleView.invalidate();
    }*/
    ...
    public void setSize(int size) {
        ...
        // update by tab_main_setting it to null before updating its size and then
        // re-tab_main_setting it
     ...
     *
     * @param refreshing Whether or not the view should tab_main_show refresh progress.
     */
    public void setRefreshing(boolean refreshing) {
        if (refreshing && mRefreshing != refreshing) {
            // scale and tab_main_show
...
//    tab_main_public boolean canChildScrollUp() {
//        if (android.os.Build.VERSION.SDK_INT < 14) {
//            if (mTarget instanceof AbsListView) {
//                final AbsListView absListView = (AbsListView) mTarget;
