 ...
 * <p/>
 * The way to use this class is to a) instantiate it programmatically or b)
...
public class MediaController extends FrameLayout {
    ...
    // View.onFinishInflate() is called after a view (and its children) is inflated from XML
    @Override
    ...
    public void setWindowLayoutType() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            try {
                // comment out by paul, cus this line will cause activity move up...
    ...
    public void setFileName(String name) {
        ...
        if (mFileName != null) {
            mFileName.setText(mTitle);
            // by paul need to be set selected before marquee works
            mFileName.setSelected(true);
        }
    }
