...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
   ...
   *                    </ul>
   * @param aspectRatio video aspect ratio, will auto detect if 0.
   */
  ...
  private void attachMediaController() {
    if (mMediaPlayer != null && mMediaController != null) {
      ...
      if (mUri != null) {
        ...
        // by paul
        mMediaController.setFileName("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ");
        // set full screen click listener
        mMediaController.mFullScreenButton.setOnClickListener(mFullScreenListener);
      }
    }
  }
  ...
  private View.OnClickListener mFullScreenListener = new View.OnClickListener() {
    public void onClick(View v) {
      boolean full = mVideoLayout == VIDEO_LAYOUT_STRETCH;
      if (full) {
